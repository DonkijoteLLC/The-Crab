...
def generate_launch_description():
	...
	urdf_file_name  = 'urdf/petricor_platform_arm.xacro'
	...
	load_joint_velocity_controller = ExecuteProcess(
		cmd=['ros2', 'control', 'load_controller', '--set-state', 'start', 'velocity_controllers'],
		output='screen'
	)
	...
	joint_event = RegisterEventHandler(
			event_handler=OnProcessExit(
				...
				on_exit=[load_joint_velocity_controller, load_joint_position_controller],
			))
